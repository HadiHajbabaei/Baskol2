...
{
    public class View_TozinCompleteMap : EntityTypeConfiguration<View_TozinComplete>
    {
        public View_TozinCompleteMap()
        {
            // Primary Key
            this.HasKey(t => new { t.CarPuID, t.SabtMahsolPuID, t.VahedPuID,t.DriverPuID,t.Tozin1PuID,t.Tozin2PuID });
